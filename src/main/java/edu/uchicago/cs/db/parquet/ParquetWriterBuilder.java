...
public class ParquetWriterBuilder extends Builder<String[], ParquetWriterBuilder> {

    private WriteSupport<String[]> writeSupport = null;
...
//    static ValuesWriterFactory factory = new DefaultValuesWriterFactory();
    ...
    public static ParquetWriter<String[]> buildDefault(Path file, MessageType schema)
            throws IOException {
    ...
    public static ParquetWriter<String[]> buildForTable(Path file, MessageType schema)
            throws IOException {
        ParquetWriterBuilder builder = new ParquetWriterBuilder(file, schema, factory);
    ...
    public static ParquetWriter<String[]> buildCompressed(Path file, MessageType schema, CompressionCodecName codec) throws IOException {
        ParquetWriterBuilder builder = new ParquetWriterBuilder(file, schema, factory);
