...
import org.apache.parquet.column.values.dictionary.OnePassOrderPreservingDictionaryValuesWriter;
...
//                        properties.getAllocator());
                // Use OPOP_DICTIONARY
                return new OnePassOrderPreservingDictionaryValuesWriter.BinaryWriter(
                        properties.getDictionaryPageSizeThreshold(),
                        properties.getAllocator());
            case INT32:
                return new OnePassOrderPreservingDictionaryValuesWriter.IntegerWriter(
                        properties.getDictionaryPageSizeThreshold(),
                        properties.getAllocator());
            case INT64:
            ...
            case INT96:
                return new DictionaryValuesWriter.PlainFixedLenArrayDictionaryValuesWriter(
                        ...
                        properties.getAllocator());
            case DOUBLE:
                return new OnePassOrderPreservingDictionaryValuesWriter.DoubleWriter(
                        properties.getDictionaryPageSizeThreshold(),
                        properties.getAllocator());
            case FLOAT:
